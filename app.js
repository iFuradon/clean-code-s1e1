...
var taskInput=document.getElementById("new-item__input");//Add a new task.
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("todo__item__edit");
    ...
    listItem.classList.toggle("todo__item__edit");
};
